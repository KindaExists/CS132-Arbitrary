...
<article id="results" class="flex flex-col items-center gap-8 px-8 lg:px-28 xl:px-56 py-32">
		...
		<ResultsCard title="Frequency of words">
			<div class="flex flex-col gap-4">
				...
				<p class="prose text-lg text-justify max-w-full">
					...
					can be accomplished through various methods but one of the most common tactics of spam
					messages is to take advantage of scarcity and desires [4]. Certain words are more
					effective for this than others and may be an indicator of spam.
				</p>
			</div>
			...
			<figure>
				<img
					src={wordFreq}
					alt="bar plot of frequency of words in spam SMS"
			...
			<div class="flex flex-col gap-2">
				...
				<figure>
					<img
						src={wordFreqPre}
						alt="bar plot of frequency of words in spam SMS (pre-simreg)"
						class="border border-neutral-500"
					/>
				</figure>
			</div>
			...
			<div class="flex flex-col gap-2">
				...
				<figure>
					<img
						src={wordFreqPost}
						alt="bar plot of frequency of words in spam SMS (post-simreg)"
						class="border border-neutral-500"
					/>
				</figure>
			</div>
		...
		<ResultsCard title="Frequency of spam messages received by day of the week">
			<div class="flex flex-col gap-4">
				...
				<p class="prose text-lg text-justify max-w-full">
					...
					week could be said to be irrelevant to the sources of these spam messages.
				</p>
			</div>
			<hr class="h-px border-neutral-500 border-dotted border-t-4 w-1/2" />
			<div class="flex flex-col xl:flex-row gap-12 xl:gap-8">
				<div class="flex flex-col gap-2">
					...
					<figure>
						<img
							src={dayWeeksPre}
							alt="bar plot of frequency of spam messages received by day of the week (pre-simreg)"
							class="border border-neutral-500"
						/>
					</figure>
				</div>
				...
				<div class="flex flex-col gap-2">
					...
					<figure>
						<img
							src={dayWeeksPost}
							alt="bar plot of frequency of spam messages received by day of the week (post-simreg)"
							class="border border-neutral-500"
						/>
					</figure>
				</div>
		...
		<ResultsCard title="Top-level domains of links in spam messages">
			<div class="flex flex-col gap-4">
				...
				<p class="prose text-lg text-justify max-w-full">
					...
					various psychological aspects, then the link is presented as the "gateway" to resolve
					those. However, the presence of a link in a message, though a good indicator, is not a
					conclusive metric.
					<br /><br />
					Another important component of website links is the top-level domain (TLD) such as .com, .edu,
					and etc. No hypothesis testing was done for TLDs, TLDs are moderated by the Internet Corporation
					for Assigned Names and Numbers (ICANN) and the restrictions for each type can vary, however,
					lesser known TLDs have less stringent restrictions when compared to TLDs like ".com.ph" [5].
					As a result, websites within these lesser known TLDs can be malicious in nature, therefore,
					links' TLDS are also a good indicator.
				</p>
			</div>
			<hr class="h-px border-neutral-500 border-dotted border-t-4 w-1/2" />
			<div class="flex flex-col gap-2">
				...
				<figure>
					<img
						src={tldPre}
						alt="bar plot of top-level domains of links in spam messages (pre-simreg)"
						class="border border-neutral-500"
					/>
				</figure>
			</div>
			...
			<div class="flex flex-col gap-2">
				...
				<figure>
					<img
						src={tldPost}
						alt="bar plot of top-level domains of links in spam messages (post-simreg)"
						class="border border-neutral-500"
					/>
				</figure>
			</div>
		...
		<ResultsCard title="Character length of spam messages">
			<div class="flex flex-col gap-4">
				...
				<p class="prose text-lg text-justify max-w-full">
					...
					160 characters per peso that prepaid carriers charge users for sending SMS messages. The
					test result may be an indicator that spammers made little to no changes in terms of
					content.
				</p>
			</div>
			<hr class="h-px border-neutral-500 border-dotted border-t-4 w-1/2" />
			<div class="flex flex-col gap-2">
				...
				<figure>
					<img
						src={lengthPre}
						alt="histogram of character lengths of spam messages (pre-simreg)"
						class="border border-neutral-500"
					/>
				</figure>
			</div>
			...
			<div class="flex flex-col gap-2">
				...
				<figure>
					<img
						src={lengthPost}
						alt="histogram of character lengths of spam messages (post-simreg)"
						class="border border-neutral-500"
					/>
				</figure>
			</div>
	...
	<a
		target="_blank"
		href="https://colab.research.google.com/drive/1M8YJQMv2aG4FSf4ppGqhyp7ngR2VqLvG?usp=sharing"
		class="btn btn-accent btn-lg text-lg text-white shadow-md">Visit the Jupyter Notebook</a
	>
</article>
