	...
	<section class="grid grid-cols-1 md:grid-cols-2 gap-8">
		...
		<MethodologyCard>
			...
			<p class="text-blue text-lg text-justify">
				...
				<br /><br />
				From this, each entry was assigned to a cluster depending on which topic it was most dominantly
				similar to, thus grouping SMS messages with similar or possibly related content.
			</p>
		</MethodologyCard>
		<MethodologyCard>
